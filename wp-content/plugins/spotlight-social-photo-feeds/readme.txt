...
Embed Instagram photos & videos in 3 minutes or less. Fully responsive, multiple feeds, lightbox, and much more.

[Demo](https://spotlightwp.com/demo/?utm_source=readme&utm_medium=readme_desc&utm_campaign=readme_desc_topcta) | [Documentation](https://docs.spotlightwp.com/) | [Support](https://spotlightwp.com/support/?utm_source=readme&utm_medium=readme_desc&utm_campaign=readme_desc_topcta) | [**Compare free vs PRO**](https://spotlightwp.com/features/compare-free-vs-pro/?utm_source=readme&utm_medium=readme_desc&utm_campaign=readme_desc_topcomparecta)

== A dead-simple Instagram feed plugin ==

Rated 5 out of 5 stars by everyone from WordPress beginners to experienced developers.

Quick to connect, fun to design, and simple to add to your site. No code or complex shortcodes required. Use the **live preview customizer** to get an instant look at your creation without ever leaving the page and set up your Instagram feeds in 3 minutes or less:
...
> Out of all of the Instagram integration plugins out there, this is one that I would by far recommend the most. [...] The team behind the Spotlight plugin are responsive and helpful.
...
> - [Andrew from Mirror Friendly](https://wordpress.org/support/topic/straightforward-neat-and-effective/)
...
Level up your Instagram feeds with **[Spotlight PRO](https://spotlightwp.com/pricing/?utm_source=readme&utm_medium=readme_desc&utm_campaign=readme_desc_upgrade)** and make the most of your Instagram marketing efforts. Design unique-looking feeds, feature hashtag campaigns, set up feeds with specific posts, and much more.
...
- Link media to blog posts, pages, WooCommerce products, custom links and more
- Masonry layout
- Highlight layout
- Hover styles
- Header styles
...
== Recommended by trusted WordPress experts ==
...
- Qode Interactive: [How to Display Your Instagram Feed on Your WordPress Website](https://qodeinteractive.com/magazine/add-instagram-feed-to-wordpress#using-the-spotlight-instagram-feeds-plugin)
- Kevin Muldoon: [Spotlight - The Instagram Engagement WordPress Plugin](https://www.kevinmuldoon.com/spotlight-the-instagram-engagement-wordpress-plugin/)
- Progressus: [How Instagram Feeds Can Improve Conversions and Gain New Followers](https://progressus.io/how-instagram-feeds-can-improve-conversions-and-gain-new-followers/)
- wpDataTables: [Which of these WordPress Instagram plugin options is best for you?](https://wpdatatables.com/wordpress-instagram-plugin/)
